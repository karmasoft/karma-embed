$(function() {
    ...
    $.getJSON("https://qa1.karmasoftonline.com"  + "/schedule.json", function(data) {
        var schedule;
    ...
    $.getJSON("https://qa1.karmasoftonline.com"  + "/member/workshops.json", function(data) {
        var workshops;
    ...
    $.getJSON("https://qa1.karmasoftonline.com"  + "/users/profiles.json", function(data) {
        var instructors;
    ...
    return $.getJSON("https://qa1.karmasoftonline.com"  + "/member/store.json", function(data) {
        var store;
