$(function() {
    ...
    $.getJSON("demo.karmasoft.io"  + "/schedule.json", function(data) {
        var schedule;
    ...
    $.getJSON("demo.karmasoft.io"  + "/member/workshops.json", function(data) {
        var workshops;
    ...
    $.getJSON("demo.karmasoft.io"  + "/users/profiles.json", function(data) {
        var instructors;
    ...
    return $.getJSON("demo.karmasoft.io"  + "/member/store.json", function(data) {
        var store;
